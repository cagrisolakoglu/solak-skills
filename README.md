...
| [solak-design-ui](skills/solak-design-ui/SKILL.md) | UX-first veri-yoğun ürün UI'ı: görev analizi → layout → TODO → adım adım uygulama. Tablo, filtre, form, dashboard. Kendi kendine yeten, İngilizce | 🚧 draft |
